...
const { getAllWorkingReport } = useWorkingReportStore()
const { userInfo } = storeToRefs(useUserStore())
const { allWorkingReport } = storeToRefs(useWorkingReportStore())
...
onMounted(async () => {
	await getProfile()
	getAllWorkingReport(userInfo.value.department)
})
	...
	<div class="project-manager p-4">
		...
		<table id="tableComponent" class="table table-bordered table-striped">
			...
			<tbody class="table-body">
				<tr v-for="item in allWorkingReport" :key="item">

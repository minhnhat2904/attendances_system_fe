...
<template>
	<div :class="isExpanded ? 'is-expanded' : ''" class="side-bar">
		...
		<div class="side-bar_list">
			<router-link class="side-bar-item" to="/projectManager/listMember">
				<span class="material-symbols-outlined side-bar-icon"> add_circle </span>
				<span class="title" v-if="isExpanded">List request</span>
			</router-link>
			<router-link class="side-bar-item" to="/projectManager/confirmRequest">
